...
import ListarCategoriasAtendimento from "./listarCategorias";
import CadastrarCategoriaAtendimento from "./cadastrarCategoria";

export default function CategoriaAtendimento() {
    ...
    <div className="container py-4">
      ...
      <div className="mb-4">
        <div className="d-flex align-items-center gap-3 mb-3">
          ...
          >
            <i
              className="bi bi-tags-fill text-white"
          ...
          <div>
            ...
            <p className="text-muted mb-0">
              Neste módulo, você poderá gerenciar as categorias de atendimento,
              como: criar, excluir, atualizar.
            </p>
          </div>
        </div>
      </div>
      ...
      <div>
        {abaAtiva === "listar" && <ListarCategoriasAtendimento />}
        {abaAtiva === "cadastrar" && <CadastrarCategoriaAtendimento />}
      </div>
